...
from backend.models.db_models import Trade
from backend.models.schemas import TradeOut
...
async def list_trades(
    ...
    """Return all trades, optionally filtered by status and/or sport."""
...
async def resolve_trade(
    ...
    """Manually resolve an open trade (useful for paper-trading testing)."""
